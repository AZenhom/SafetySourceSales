package com.safetysource.admin.ui.splash
...
import com.safetysource.admin.databinding.ActivitySplashBinding
import com.safetysource.admin.ui.host.HostActivity
...
class SplashActivity : BaseActivity<ActivitySplashBinding, SplashViewModel>() {
    ...
    private fun openPhoneAuthScreen() {
        loginResultLauncher.launch(PhoneAuthActivity.getIntent(this, AccountType.ADMIN))
    }
    ...
    private fun showNotRegisteredSheet() {
        ...
        infoDialog = InfoDialog(
            ...
            message = getString(R.string.admin_not_registered),
